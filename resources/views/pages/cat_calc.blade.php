    ...
    <main class="main">
        ...
        <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/);">
            <div class="container position-relative">
                <h1 data-translate="pets.cat_calc">Cat's Calories Calculator</h1>
            </div>
        </div>
        ...
        <section id="about-3" class="section py-3">
            <div class="container">
                <div class="row">
                    <div class="col-12 mb-4">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page" data-translate="pets.cat_calc">
                                    Cat's Calories Calculator
                                </li>
                            </ol>
                        </nav>
                    ...
                    <div class="col-12">
                        <h2 class="content-title articleTitle mb-5" data-translate="pets.cat_calc">
                            Cat's Calories Calculator
                        </h2>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card calculator">
                                    ...
                                    <div>
                                        <label>
                                            ...
                                            <select id="petType">
                                                <option value="" data-translate="pets.select_type">-- Select Pet
                                                    --</option>
                                                <option value="cat" data-translate="pets.cat" selected>Cat</option>
                                            </select>
                                        </label>
                                        ...
                                        <label>
                                            ...
                                            <select id="lifeStage">
                                                ...
                                                <option value="kitten" data-translate="pets.kitten_cat">Kitten
                                                </option>
                            ...
                            <div class="mt-2 results">
                                <button id="calculateBtn" disabled data-translate="calory.calculate">Calculate</button>
        ...
        <section class="our-process section py-5">
            <div class="container">
                <div data-aos="fade-up" class="qualityAss_content">
                    <h2 data-translate="pets.cat_calc_important" class="mb-4">
                        The Importance of a Calorie Calculator for Cats
                    </h2>
                    <p data-translate="pets.dog_calc_important_desc">
                        Calculating your cat's calorie needs will help you ensure they get the right amount of food each
                        day.
                        Feeding cats the
                    ...
                    <h2 data-translate="pets.cat_calc_factors" class="mb-4">
                        Factors Affecting Calorie Counts for Cats
                    </h2>
                    <h4 data-translate="pets.cat_calc_factors_age">
                        Cat Age and Different Life Stages
                    </h4>
                    <p data-translate="pets.cat_calc_factors_age_desc">
                        Calorie needs vary by life stage. Puppies' needs differ from those of adult cats, and pregnant
                        or lactating
                        female cats
                        require more calories than the average adult cat.
                    </p>
                    <h4 data-translate="pets.calc_factors_activity">
                        Activity Level
                    </h4>
                    <p data-translate="pets.cat_calc_factors_activity_desc">
                        Each cat breed varies in activity level. Active cats burn more calories than sedentary cats, so
                        they need
                        more calories
                        each day.
                    </p>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const PRODUCTS = [
                // Cats
                {
                    ...
                    brand: "Petzybites",
                    name: "Bessa Bites",
                    desc: t("brands.bessa.adult.desc"),
                    benefit1: t("brands.bessa.adult.protein"),
                    benefit2: t("brands.bessa.adult.vitamins"),
                    benefit3: t("brands.bessa.adult.minerals"),
                    benefit4: t("brands.bessa.adult.taurine"),
                    suitableFor: t("brands.bessa.adult.suitable"),
                    image: "{{ asset('assets/img/bessa-brand.png') }}",
                    prodLink: "https://web.facebook.com/bessabites",
                ...
                },
                {
                    ...
                    brand: "Petzybites",
                    name: "MshMsh",
                    desc: t("brands.bessa.kitten.desc"),
                    benefit1: t("brands.bessa.kitten.protein"),
                    benefit2: t("brands.bessa.kitten.vitamins"),
                    benefit3: t("brands.bessa.kitten.minerals"),
                    benefit4: t("brands.bessa.kitten.dha"),
                    suitableFor: t("brands.bessa.kitten.suitable"),
                    image: "{{ asset('assets/img/mshmsh-brand.png') }}",
                    prodLink: "https://web.facebook.com/BMSHMSH",
            ...
            // Detect if we are on the "cats calories" page
            const isCatPage = window.location.pathname.includes("cat-calories-calculator");
            if (isCatPage) {
                petTypeEl.value = "cat";

                // populate life stage options مباشرة
                resetSelect(lifeStageEl, t("pets.select_life_stage"));
                const list = LIFE_STAGES["cat"] || [];
                list.forEach(stage => {
                    const opt = document.createElement("option");
