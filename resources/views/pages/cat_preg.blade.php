    ...
    <main class="main">
        ...
        <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/);">
            <div class="container position-relative">
                <h1 data-translate="pets.cat_preg">Cat's Pregnancy Calculator</h1>
            </div>
        </div>
        ...
        <section id="about-3" class="section py-3">
            <div class="container">
                <div class="row">
                    <div class="col-12 mb-4">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page" data-translate="pets.cat_preg">
                                    Cat's Pregnancy Calculator
                                </li>
                            </ol>
                        </nav>
                    ...
                    <div class="col-12">
                        <h2 class="content-title articleTitle mb-5" data-translate="pets.cat_preg">
                            Cat's Pregnancy Calculator
                        </h2>
                    </div>
                </div>
                        ...
                        <div class="card calculator">
                            <div>
                                ...
                                <div class="input-group">
                                    <label data-translate="pets.cat_preg_period">مدة الحمل (بين 58 و 67 يوم):</label>
                                    <input type="number" id="gestationDays" value="63" min="58" max="67">
                                </div>
                            </div>
        ...
        <section class="our-process section py-5">
            <div class="container">
                <div data-aos="fade-up" class="qualityAss_content">
                    <h2 data-translate="pets.cat_calc_preg" class="mb-4">
                        How long is a cat's pregnancy?
                    </h2>
                    <p data-translate="pets.cat_calc_preg_desc">
                        The gestation period for cats is about 63-65 days, and female cats can become pregnant when they
                        are as
                        young as 4
                        months old unless they are spayed to prevent this, so your cat can become a mother when she is
                        as young as
                        six months
                        old.
                    </p>
                    <h2 data-translate="pets.cat_calc_preg_signs" class="mb-4">
                        What are the signs of pregnancy in cats?
                    </h2>
                    <p data-translate="pets.pets.cat_calc_preg_signs_important">
                        You can tell that a cat is pregnant once her nipples darken and become enlarged. This usually
                        happens in the
                        third week
                        of pregnancy. You may also notice your cat gaining weight, as pregnancy tends to cause
                        significant weight
                        gain in cats.
                        A pregnant cat's belly becomes large 30 days after mating.
                    </p>
                </div>
            </div>
        </section>
...
@push('external-script')
    <script>
        ...
        function calculateBirth() {
            ...
            if (gestationDays < 58 || gestationDays > 67) {
                alert("❌ مدة الحمل لازم تكون بين 58 و 67 يوم");
                return;
            }
            ...
            maxDate.setDate(startDate.getDate() + 67);
